...
\begin{figure*}
    ...
    \begin{tikzpicture}[auto, node distance=1.5cm]
        ...
        \node [block1, left=of linear2.center, xshift=0.5cm] (Slice-MLP) {};
        \node [block1, below=of Slice-MLP.center, yshift=1cm] (Slice-MLP-below) {};
        \node [block1, below=of MLP-output1.center, yshift=1cm] (MLP-output3) {};
        \draw [-] (Slice-MLP.center) -- (Slice-MLP-below.center);
        \draw [->, rounded corners] (Slice-MLP-below.center) -- node[xshift=0.5cm] {$(N, 4)$} (MLP-output3.center) -- (cat);
    \end{tikzpicture}
    % \caption{
    %     % 
