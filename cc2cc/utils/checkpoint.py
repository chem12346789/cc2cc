"""
This module provides utilities for saving and loading model and optimizer state dictionaries
using PyTorch's distributed checkpointing features.
Copy from pytorch/examples without any modification.
See: https://github.com/pytorch/examples/blob/main/distributed/FSDP2/train.py
"""
