...
for pair in "${model_load_epoch_pairs[@]}"; do
    ...
    ~/anaconda3/envs/pyscf/bin/python collect_info.py --model_load ${model_load} --epoch ${load_epoch} --basis ${basis_args} --verbose 0 --frequency 30m --data_set dft-fitset-def2 --max_checks 0 1>log/intermol_${model_load}_${load_epoch}.log 2>log/intermol_${model_load}_${load_epoch}.err
