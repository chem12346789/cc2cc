...
\begin{figure*}
    ...
    \caption{
        ...
        %
        We use the E3nn block \cite{TODO:e3nn} to extract the invariant features from the input, and the Slice block is used to extract the energy density at the center (${\bm{e}(\brm{r}_i)}$), which is already the invariant feature, from the input.
        % 
