...
\begin{figure*}
    ...
    \begin{tikzpicture}[auto, node distance=1.5cm]
        ...
        \node [block, right=of cat, xshift=-0.2cm] (output) {Mixture};
    ...
    \caption{
        ...
        % 
        The E3nn block \cite{geigerE3nnEuclideanNeural2022-07-18} and the Slice block extract the invariant features from the input.
        % 
        The Mixture block combines the outputs from the different paths to produce the final prediction.
        % 
        The output of the neural network is the predicted energy density for the central grid point.
    }
    \label{fig:arch}
\end{figure*}