...
nohup bash -c '~/anaconda3/envs/pyscf3.8/bin/python gen_data.py -dl -0.5 0.5 11 --basis cc-pVDZ --extend_atom 0-1 --extend_xyz 0 --name_mol propyne --precision float64'  > log/gen_data.log &
