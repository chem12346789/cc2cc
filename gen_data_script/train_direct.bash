...
nohup bash -c '~/anaconda3/envs/pyscf3.8/bin/python train.py -dl -0.5 0.5 11 -b cc-pVDZ --extend_atom 0-1 0 --extend_xyz 0 --eval_step 10 --batch_size 10 --epoch 2500 --with_eval True --precision float32'  > log/train.log &
