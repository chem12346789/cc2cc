...
#
nohup bash -c '~/anaconda3/envs/pyscf/bin/python test.py -dl 0 0 1 --basis cc-pVDZ --extend_atom 0 --extend_xyz 0 --precision float64 --load cycle8 --load_epoch -10000 --dataset g2' >log/test1.log 2>&1 &
#
