...
nohup bash -c '~/anaconda3/envs/pyscf/bin/python test.py -dl -0.5 0.5 11 --basis cc-pVDZ --extend_atom 0-1 --extend_xyz 0 --precision float64 --load 2024-12-13-13-11-44 --load_epoch 49000 --name_mol methane ethane ethylene acetylene propane' >log/test0.log 2>&1 &
