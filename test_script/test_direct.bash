...
nohup bash -c '~/anaconda3/envs/pyscf/bin/python test_density.py -dl -0.5 0.5 11 --basis cc-pVDZ --extend_atom 0-1 --extend_xyz 0 --load 2024-12-04-11-37-01 --name_mol methane ethane propane' >log/test1.log 2>&1 &
