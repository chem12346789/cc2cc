...
for pair in "${model_load_epoch_pairs[@]}"; do
    ...
    ~/anaconda3/envs/pyscf/bin/python collect_info.py --model_load ${model_load} --epoch ${load_epoch} --basis ${basis_args} --verbose 0 --frequency 30m --max_checks 0 --data_set gmtkn-diet100-def2 1>log/collect_info_${model_load}_${load_epoch}_cal_100.log 2>log/collect_info_${model_load}_${load_epoch}_cal_100.err
