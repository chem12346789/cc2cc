...
~/anaconda3/envs/pyscf/bin/python test.py -dl START END STEP -b cc-pVDZ --extend_atom EXTEND_ATOM --extend_xyz 0 --load CHECKPOINT --name_mol ethylene acetylene cyclopropene cyclopropane allene propyne propane propylene butane butyne isobutane butadiene bicyclobutane cyclobutane benzene spiropentane cyclopropylmethyl neopentane cyclopentane pentane isopentane --precision float32 --load_epoch -1 >log/CHECKPOINT-START-END-STEP-EXTEND_ATOM.out
#
