...
~/anaconda3/envs/pyscf/bin/python test.py -dl -0.5 0.5 11 -b cc-pVDZ --extend_atom 0-1 --extend_xyz 0 --load CHECKPOINT --name_mol hexane octane --precision float32 --load_epoch -1 >log/CHECKPOINT.out
#
