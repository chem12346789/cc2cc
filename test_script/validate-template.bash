...
~/anaconda3/envs/pyscf/bin/python test.py -dl -0.45 0.45 10 -b cc-pVDZ --extend_atom 0 --extend_xyz 0 --load CHECKPOINT --name_mol benzene hexane --precision float32 --load_epoch -1 >log/CHECKPOINT.out
#
