...
~/anaconda3/envs/pyscf/bin/python train.py -dl -0.5 0.5 21 -b cc-pVDZ --extend_atom 0 0-1 --extend_xyz 0 --eval_step BASH_EVAL_STEP --batch_size BASH_BATCH_SIZE --epoch 25000 --with_eval BASH_WITH_EVAL --precision float32 --load BASH_LOAD_MODEL
